...
import com.bot.service.EmployeeService;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> getEmployees(@PathVariable("id") Long employeeId, @RequestParam() String str) {
	...
	public ResponseEntity<Employee> deleteEmployees(@PathVariable("id") Long employeeId) {
		HttpHeaders headers = new HttpHeaders();
		Employee employee = employeeService.getEmployee(employeeId);
		if (employee == null) {
			return new ResponseEntity<Employee>(HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<Employee> updateEmployees(@PathVariable("id") Long employeeId,
